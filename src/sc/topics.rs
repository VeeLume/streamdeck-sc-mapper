...
pub const INSTALL_ACTIVE_CHANGED: TopicId<InstallActiveChanged> = TopicId::new(
    "sc.install.active-changed"
);
...
pub const BINDINGS_REBUILD_AND_SAVE: TopicId<BindingsRebuildAndSave> = TopicId::new(
    "sc.bindings.rebuild-and-save"
);
